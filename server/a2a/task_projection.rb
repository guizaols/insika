...
module Harness
  module Server
    module A2A
      # Projeção Task (núcleo) -> A2A Task (P3A-01, D2/D3, L4-L6). PURO.
      module TaskProjection
        # Mapa de estado (D2). Estado desconhecido -> "unknown".
        STATE = {
        ...
        # completed -> conteúdo; failed -> erro; demais estados sem message (L5).
