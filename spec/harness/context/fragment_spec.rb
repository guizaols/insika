...
RSpec.describe Harness::ContextFragment do
  it "aplica defaults no .build (priority 50, tokens nil, pinned false)" do
  ...
  it "é imutável (Data); with devolve cópia" do
    ...
    expect(f.tokens).to be_nil # original intacto
  end
end
