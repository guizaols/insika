...
module Harness
  module Commands
    # Command de CONTROLE (doc 03 L1): cria uma sessão e responde síncrono —
    # não cria Task. Payload `{ vars: {} }` -> retorna Session.
    class CreateSession
      # event_stream: qualquer objeto com #emit(event) (a classe real chega na
      # task 10; testes usam spy).
      ...
      def call(command)
        ...
        # doc 07) — normaliza na borda do handler.
        ...
        # :session_created é do catálogo fechado D5 (origem: handler CreateSession).
