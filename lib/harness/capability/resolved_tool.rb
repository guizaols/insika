...
module Harness
  module Capability
    # Decorator fino (P2B-01 D4/L7): troca só o `name` exposto ao modelo pelo nome
    ...
    #
    # Ordem de embrulho no run_pipeline (P2B-01 L7): impl -> ResolvedTool ->
    ...
    # "browse") — por isso `impl_name` fica exposto aqui. Quem consome isso é a
    # task 5 (Executor / ToolEnvelope).
