  ...
  module Workflow
    ...
    Definition = Data.define(:name, :description, :input_schema, :output_schema, :factory) do
      ...
      def enforce!(schema, value, phase)
        ...
        raise Harness::WorkflowSchemaError.new(
    ...
    class Schema
      ...
      def initialize(json_schema)
        unless json_schema.is_a?(Hash)
          raise Harness::ValidationError, "workflow schema must be a JSON Schema object or a #call-able validator"
        end

        @json_schema = Harness::Coercion.deep_stringify(json_schema)
      end
