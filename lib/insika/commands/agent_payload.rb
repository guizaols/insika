  ...
  module Commands
    ...
    module AgentPayload
      ...
      FIELDS = %i[id model provider base_prompt prompt_files tools_allow tools_deny
                  ...
                  prompt_refs limits approvals_required customer_confirm capabilities subagents tools_deferred
                  memory memory_retrieval prompt_caching tool_persistence tool_output_compression fencing budget reliability alerts
