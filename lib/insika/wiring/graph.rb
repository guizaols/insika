    ...
    module Graph
      ...
      def spine(backend:, extra_policy_builtins: {})
        ...
        Spine.new(
          ...
          session_store: session_store, task_store: task_store, llm_trace_store: llm_trace_store,
...
# WS3 provider reliability (retries/backoff/fallback/breaker) is ALWAYS wired —
      ...
      executor = Insika::Executor.new(
        ...
        llm_trace_store: spine.llm_trace_store,
      ...
      Spine = Struct.new(
        :backend, :event_stream, :session_store, :task_store, :llm_trace_store, :checkpoint_store,
      ...
      Result = Struct.new(
        ...
        :session_store, :task_store, :llm_trace_store, :checkpoint_store, :pending_action_store, :delegation_store,
