...
# Builds on the SAME shared graph as config/wiring.rb (Harness::Wiring::Graph, §12
...
module Deploy
  ...
  ENV_SPECS = [
    ...
    Harness::EnvSchema.spec(name: "CONSUMER_INTERNAL_URL", type: :url, description: "Consumer internal API base (data-tool callbacks)."),
  ...
  module Wiring
    # --- Shared spine (Harness::Wiring::Graph) --------------------
