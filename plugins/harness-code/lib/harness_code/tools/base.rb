...
# Harness::Sandbox is always loaded before any plugin (the Plugin::Loader is part
...
module HarnessCode
  module Tools
    ...
    #
    # As of item 35 the injected object is the core `Harness::Sandbox::Env`
    ...
    class Base < RubyLLM::Tool
      ...
      def guard
        yield
      rescue Harness::Sandbox::Escape => e
