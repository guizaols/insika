...
(`:refinement_started`, `:refinement_report` — see [Refinement](REFINEMENT.md)) and
authoring writes (`:golden_written`, `:agent_file_written`, …) travel the same stream
and are **ignored** by the bridge: they open no span and
